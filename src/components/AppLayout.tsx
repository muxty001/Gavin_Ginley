...
const AppLayout: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['hero', 'about', 'music', 'youtube', 'gallery', 'signup', 'contact'];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <button
                ...
                className={`text-sm uppercase tracking-widest transition-colors ${activeSection === link.id ? 'text-purple-400' : 'text-gray-400 hover:text-white'}`}
              >
                {link.label}
              </button>
            ))}
      ...
      <section id="about" className="py-32 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-8">About</h2>
          <p className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed text-gray-200">
            An artist forging a new sound at the intersection of raw emotion and sonic innovation. 
            Building something different — something real.
          </p>
      ...
      <section id="music" className="py-32 px-6 bg-gradient-to-b from-[#0a0a0a] via-purple-950/10 to-[#0a0a0a]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-8">Music</h2>
          <div className="relative">
            ...
            <div className="relative z-10 py-20">
              ...
              <p className="text-xl text-gray-400 tracking-wider">Coming Soon</p>
              ...
              <p className="mt-8 text-gray-500 text-sm uppercase tracking-widest">New music loading</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="youtube" className="py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-12 text-center">YouTube</h2>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-6">Music videos, visuals & trailers coming soon</p>
            <a 
              href="https://www.youtube.com/@GavinGinleyOfficial"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="py-20 px-6 bg-[#080808]">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-8">Visuals</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {['Music Video', 'Behind the Scenes', 'Live Performance'].map((title, index) => (
              <div key={index} className="aspect-video bg-[#111] rounded-lg border border-white/5 flex items-center justify-center group hover:border-purple-500/30 transition-all duration-300">
                <div className="text-center">
                  <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mx-auto mb-3 group-hover:bg-purple-500/20 transition-colors">
                    <svg className="w-5 h-5 text-gray-500 group-hover:text-purple-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M8 5v14l11-7z"/>
                    </svg>
                  </div>
      ...
      <section id="gallery" className="py-32 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-12 text-center">Gallery</h2>
      ...
      <section id="signup" className="py-32 px-6 bg-gradient-to-b from-[#0a0a0a] via-purple-950/20 to-[#0a0a0a]">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-4">Stay Connected</h2>
          <h3 className="text-3xl md:text-4xl font-bold mb-4">Join the Journey</h3>
          <p className="text-gray-400 mb-8">Be the first to hear new music, see exclusive content, and get updates on upcoming releases.</p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-8">Follow</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h3 className="text-2xl font-bold mb-4">Management & Inquiries</h3>
              <p className="text-gray-400 mb-6">For booking, press, and business inquiries.</p>
              <a 
            ...
            <div>
              <h2 className="text-sm uppercase tracking-[0.3em] text-purple-400 mb-4">Location</h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold tracking-wider">GAVIN GINLEY</span>
            </div>
            <div className="flex items-center gap-6">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/@GavinGinleyOfficial" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
